...
**Core:** list_mailboxes, search_messages, get_messages, send_email, mark_as_read
**Attachments & Management:** send_email_with_attachments, save_attachments, move_messages, flag_message, create_mailbox, delete_messages
